...
def init():
    ...
    while count < 5:
        ...
        prod_1 = np.floor(np.random.uniform(0,N))
        while prod_1 in P or prod_1 in Q:
            prod_1 = np.floor(np.random.uniform(0,N))
    ...
    return PRODUCTS, SHELVES, SEGMENTS, lmbd, L, H1, H2, H3, P, Q
...
def build_problem(products, shelves, segments, rel, first, ineq2, ineq3,SSP,L,H1,H2,H3,P,Q,L_dummy, H1_dummy, H2_dummy, H3_dummy,products_total,x=0,y=0,s=0,q=0,z=0,**kwargs):
